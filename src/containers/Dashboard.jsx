        ...
        <Box sx={styles.columnsContainer}>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Box sx={styles.postAuthorSection}>
                        <Avatar sx={styles.avatar} src="src/assets/avatars/woman.jpeg"/>
                        <Typography sx={styles.postMeta}>React with Nevina</Typography>
                        <Typography sx={styles.postMeta}>June 11, 2023</Typography>
                    </Box>
                    <Typography variant="body2">I asked ChatGPT to tell me a joke about React JS, he is not only smart but also funny :) we are going to make a video about it tomorrow.</Typography>
            ...
            <Card sx={styles.item}>
                <CardContent>
                    ...
                    <Divider sx={styles.divider} />
                    <Box sx={styles.commentRow}>
                        <Avatar sx={styles.avatar} alt="Woman" src="src/assets/avatars/woman.jpeg" />
