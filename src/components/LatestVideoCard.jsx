...
function LatestVideoCard(props) {
    return ( <Card {...props}>
        <CardContent>
            ...
            <Typography sx={styles.cardActions} variant='link'>GO TO VIDEO ANALYTICS</Typography>
            <Typography sx={styles.cardActions} variant='link'>SEE COMMENTS(12)</Typography>
        </CardContent>
    </Card> );
}
